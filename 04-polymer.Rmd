...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Profil saturasi air di reservoir di bawah kondisi _polymer flood_"}
knitr::include_graphics("images/polymer/saturasipoly.png")
```
<p> &nbsp; </p>
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Kurva _fractional flow_ untuk _polyer flood_"}
knitr::include_graphics("images/polymer/ffpoly.png")
```
<p> &nbsp; </p>
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Model _streamtube_"}
knitr::include_graphics("images/polymer/streamtube.png")
```
<p> &nbsp; </p>
