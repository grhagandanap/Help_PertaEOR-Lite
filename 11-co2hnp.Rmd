...
```{r fig.align = 'center', out.width = "50%", fig.cap="Model sintetis reservoir untuk pembuatan model prediktif CO~2~ huff & puff"}
knitr::include_graphics("images/co2huffnpuff/sintesis.png")
```
...
```{r fig.align = 'center', out.width = "50%", fig.cap="_Phase envelope_ fluida reservoir yang digunakan untuk membangun model prediktif."}
knitr::include_graphics("images/co2huffnpuff/phase.png")
```
...
knitr::include_graphics("images/co2huffnpuff/proxy.png")
```
