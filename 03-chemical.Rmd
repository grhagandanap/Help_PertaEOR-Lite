...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Klasfikasi teknologi injeksi kimia (Afeez dkk)"}
knitr::include_graphics("images/chemical/klasifikasi.png")
```
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Beberapa pola sumur injeksi (Latil dkk)"}
knitr::include_graphics("images/chemical/pola.png")
```
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Model _pattern_ 7-_spot_"}
knitr::include_graphics("images/chemical/seven.png")
```
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Model _pattern_ 9-_spot_"}
knitr::include_graphics("images/chemical/nine.png")
```
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Perbandingan laju alir minyak hasil model prediktif PertaEOR-Lite dan simulator pada pola injeksi 7-_spot_ dan 9-_spot_"}
knitr::include_graphics("images/chemical/simulasi.png")
```
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Perbandingan laju alir minyak dan laju alir kumulatif minyak hasil model prediktif PertaEOR-Lite pada pola injeksi 5-_spot_, 7-_spot_ dan 9-_spot_"}
knitr::include_graphics("images/chemical/perbandingan.png")
```