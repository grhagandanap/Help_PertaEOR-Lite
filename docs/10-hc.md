...
<p class="caption">(\#fig:unnamed-chunk-2)Diagram terner C~1~, n-C~4~ dan C~10~ pada 2500 psia dan 160 °F (Hutchinson and Braun, 1961)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-3)Diagram terner C~1~, n-C~4~ dan C~10~ pada 160 °F dengan tekanan kondisi berbeda, 2500 dan 3200 psia (Hutchinson and Braun, 1961)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-4)Diagram pseudo-terner sistem hidrokarbon kompleks (Hutchinson and Braun, 1961)</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-5)Mekanisme _Vaporizing Gas Drive_ (VCD) pada diagram pseudo-terner sistem hidrokarbon kompleks</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-6)Mekanisme _Condensing Gas Drive_ (CGD) pada diagram pseudo-terner sistem hidrokarbon kompleks</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-7)Model sintesis reservoir untuk pembuatan Hydrocarbon Injenction Predictive Model</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-8)Komposisi fluida reservoir untuk jenis API berbeda</p>
</div>
<p> &nbsp; </p>
...
<p class="caption">(\#fig:unnamed-chunk-9)Kurva permeabilitas relatif minyak-air</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-10)Kurva permeabilitas relatif liquid-gas</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-11)Pembangunan profil produksi fluida reservoir berdasarkan _Proxy Model_</p>
</div>
