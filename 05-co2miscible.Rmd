...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Skematik dari jalur komposisi"}
knitr::include_graphics("images/co2miscible/skema.png")
```
<p> &nbsp; </p>
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Skema dari plot _flux_-konsentrasi"}
knitr::include_graphics("images/co2miscible/skema2.png")
```
<p> &nbsp; </p>
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "_Effluent histories_"}
knitr::include_graphics("images/co2miscible/effluent.png")
```
<p> &nbsp; </p>
