...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Luas daerah (probabilitas) di bawah kurva distribusi normal untuk masing-masing _range_ standard deviasi dari _mean_"}
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Titik x~p~ merupakan titik potong antara kurva distribusi database dengan kurva distribusi input. Titik potong ini dicari menggunakan metode Newton-Raphson"}
...
```{r fig.align = 'center', out.width = "75%", fig.cap="Persebaran penerapan metode EOR di seluruh dunia"}
knitr::include_graphics("images/screening/ogj.png")
```
```{r fig.align = 'center', out.width = "75%", fig.cap="Peta persebaran aplikasi EOR"}
knitr::include_graphics("images/screening/negara.png")
```
...
```{r fig.align = 'center', out.width = "100%"}
knitr::include_graphics("images/screening/sum1.png")
```
```{r fig.align = 'center', out.width = "100%", fig.cap="_Summary database_ EOR"}
knitr::include_graphics("images/screening/sum2.png")
```
...
```{r fig.align = 'center', out.width = "75%", fig.cap="Tampilan input net thickness pada PertaEOR untuk _single value_ dan _distribution value_"}
knitr::include_graphics("images/screening/value.png")
```
...
```{r fig.align = 'center', out.width = "100%", fig.cap="Perbandingan hasil perhitungan menggunakan parameter _dipping_"}
knitr::include_graphics("images/screening/dipping.png")
```
...
```{r fig.align = 'center', out.width = "75%", fig.cap="Parameter _screening_ EOR di beberapa lapangan"}
knitr::include_graphics("images/screening/parameter.png")
```
...
```{r fig.align = 'center', out.width = "125%", fig.cap="Hasil _screening_ PertaEOR-Lite"}
knitr::include_graphics("images/screening/hasil.png")
```
...
```{r fig.align = 'center', out.width = "50%", fig.cap="Parameter _screening_ EOR di Lapangan Southwest of Iran"}
knitr::include_graphics("images/screening/iran1.png")
```
```{r fig.align = 'center', out.width = "50%", fig.cap="Hasil _screening_ EOR di apangan Southwest of Iran"}
knitr::include_graphics("images/screening/iran2.png")
```