...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Pembentukan _streamline_ baru akibat adanya sumur _infill_"}
knitr::include_graphics("images/infill/streamline.png")
```
<p> &nbsp; </p>
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Bentuk elemen yang digunakan dalam penerapan metode _finite element_"}
knitr::include_graphics("images/infill/bentukelemen.png")
```
<p> &nbsp; </p>
...
```{r fig.align = 'center', out.width = "50%", fig.cap = "Pembagian _node_ besar menjadi _node_ yang lebih kecil dalam _finite element_"}
knitr::include_graphics("images/infill/node.png")
```
<p> &nbsp; </p>
